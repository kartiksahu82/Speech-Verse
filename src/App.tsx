    ...
    return (
        <div className='flex justify-center items-center min-h-screen bg-zinc-900 text-zinc-100 px-4'>
            <div className='w-full max-w-3xl flex flex-col justify-center items-center p-4 sm:p-6 rounded-xl shadow-xl bg-zinc-800/60 backdrop-blur-md border border-zinc-700'>
                <h1 className='mb-8 text-4xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight text-transparent mb-2 bg-clip-text bg-gradient-to-r from-purple-400 via-pink-500 to-red-500 drop-shadow-[0_0_15px_rgba(255,0,150,0.5)] text-center'>
                    Speech-Verse
                </h1>

                <h2 className='mt-2 mb-4 px-2 text-center mb-3 text-lg sm:text-xl lg:text-2xl font-medium tracking-tight text-zinc-300'>
